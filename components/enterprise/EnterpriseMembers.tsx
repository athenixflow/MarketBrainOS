// Enterprise Suite — Members panel. Owner/executive-admin provisions members directly (active
// immediately) with a role, tool allowlist, and token budget. The allowlist/budget are STORED now and
