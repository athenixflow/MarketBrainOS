// Inline SVG icons for the docs hub. The app has no icon library — icons are hand-drawn SVG paths
// (heroicons-style), colored via `currentColor` and sized with Tailwind.

import React from 'react';

const PATHS: Record<string, React.ReactNode> = {
  rocket: <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 8.65m5.96 5.72a14.926 14.926 0 01-5.841 2.58m-.119-8.3a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.46a3 3 0 11-4.242-4.242" />,
