// Team Workspace — Members panel. Two ways to add someone: invite by email (manageMembership 'invite';
...
// budget drawn from the team pool. The allowlist + budget gate the member's team-scope analyses in
// executeAnalysis. Markup is kept identical to agency/AgencyMembers and enterprise/EnterpriseMembers.
