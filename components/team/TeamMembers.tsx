        ...
        <Card title={editingUid ? 'Edit member' : 'Add a team member'}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 [&>div]:mb-6">
            ...
            <div>
              ...
              <select value={role} onChange={(e) => setRole(e.target.value as WorkspaceRole)} className="w-full min-w-0 bg-[#FBFBFB] border border-gray-200 px-4 py-3.5 rounded-2xl text-[15px] outline-none">
